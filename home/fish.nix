...
''}
      ...
      set -gx FORGIT_SHOW_FZF_OPTS "--preview-window=bottom:90%"
      set -gx FORGIT_BLAME_FZF_OPTS "--preview-window=bottom:90%"
      set -gx FORGIT_REFLOG_FZF_OPTS "--preview-window=bottom:90%"
