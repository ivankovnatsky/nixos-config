...

{
  ...
  # Unreal Tournament 1999 configuration with WASD controls
  # Config stored in ~/.utpg/System/User.ini
  # To compare with defaults: cat $(readlink -f $(which ut1999) | xargs dirname)/DefUser.ini
  home.file.".utpg/System/User.ini".text = ''
    [DefaultPlayer]
    Name=Player
