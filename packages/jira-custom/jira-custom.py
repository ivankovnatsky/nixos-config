...
def main():
    ...
    desc_get_parser.add_argument("issue_key", help="Issue key (e.g., PROJ-12345)")

    # issue desc update
    desc_update_parser = desc_subparsers.add_parser("update", help="Update issue description")
    desc_update_parser.add_argument("issue_key", help="Issue key (e.g., PROJ-12345)")
    ...
    status_parser.add_argument("issue_key", help="Issue key (e.g., PROJ-12345)")

    # issue transition
    transition_parser = issue_subparsers.add_parser("transition", help="Transition an issue")
    transition_parser.add_argument("issue_key", help="Issue key (e.g., PROJ-12345)")
    ...
    transitions_parser.add_argument("issue_key", help="Issue key (e.g., PROJ-12345)")
    ...
    list_parser.add_argument("issue_key", help="Issue key (e.g., PROJ-12345)")

    # issue comment add
    add_parser = comment_subparsers.add_parser("add", help="Add a comment to an issue")
    add_parser.add_argument("issue_key", help="Issue key (e.g., PROJ-12345)")
    ...
    update_parser.add_argument("issue_key", help="Issue key (e.g., PROJ-12345)")
    ...
    delete_parser.add_argument("issue_key", help="Issue key (e.g., PROJ-12345)")
