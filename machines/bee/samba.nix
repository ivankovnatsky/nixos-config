{
  ...
  # This enables sharing of the /storage/Data directory over the network
  ...
  # 2. OR press Cmd+K and enter: smb://bee.local/storage/Data or smb://bee/storage/Data
  ...
  # 2. OR enter \\\\bee\\storage\\Data in the address bar
  # 3. Provide username and password when prompted
