{ config, ... }:
{
  ...
  services.transmission = {
    ...
    settings = {
      ...
      # Download settings
      download-dir = "/var/lib/transmission/media/downloads";
      incomplete-dir = "/var/lib/transmission/media/downloads/.incomplete";
      incomplete-dir-enabled = true;
      watch-dir = "/var/lib/transmission/media/downloads/watchdir";
