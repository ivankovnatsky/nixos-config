{
  ...
  #   * Series → Add Root Folder → /mnt/mac/Volumes/Storage/Data/media/tv
  services.sonarr = {
    enable = true;
    openFirewall = true;
  ...
  systemd.tmpfiles.rules = [
    "d /mnt/mac/Volumes/Storage/Data/media/tv 2775 sonarr media -" # Main TV shows directory with setgid
    "d /mnt/mac/Volumes/Storage/Data/media/downloads/tv-sonarr 0775 transmission media -" # Where Transmission puts downloaded TV shows
    ...
    "A+ /mnt/mac/Volumes/Storage/Data/media/downloads/tv-sonarr - - - - default:user::rwx,default:group::rwx,default:other::r-x"

    # Set proper default ACLs for the TV shows directory
    "A+ /mnt/mac/Volumes/Storage/Data/media/tv - - - - default:user::rwx,default:group::rwx,default:other::r-x"
  ];
