{ config, ... }:
{
  ...
  services.transmission = {
    ...
    settings = {
      ...
      rpc-enabled = true;
      rpc-bind-address = "0.0.0.0"; # Bind to all interfaces for OrbStack NAT routing
      rpc-port = 9091;
      ...
      # Download settings
      download-dir = "/mnt/mac/Volumes/Storage/Data/media/downloads";
      incomplete-dir = "/mnt/mac/Volumes/Storage/Data/media/downloads/.incomplete";
      incomplete-dir-enabled = true;
      watch-dir = "/mnt/mac/Volumes/Storage/Data/media/downloads/watchdir";
