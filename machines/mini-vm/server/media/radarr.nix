{
  ...
  #   * Movies → Add Root Folder → /mnt/mac/Volumes/Storage/Data/media/movies
  ...
  systemd.tmpfiles.rules = [
    ...
    "d /mnt/mac/Volumes/Storage/Data/media 0775 root media - -"

    # Radarr-specific directories
    "d /mnt/mac/Volumes/Storage/Data/media/movies 2775 radarr media -" # Main movies directory with setgid
    "d /mnt/mac/Volumes/Storage/Data/media/downloads 2775 transmission media -" # Where Transmission puts downloaded movies with setgid
    "d /mnt/mac/Volumes/Storage/Data/media/downloads/radarr 0775 transmission media -" # Radarr's download directory
    ...
    "A+ /mnt/mac/Volumes/Storage/Data/media/downloads/radarr - - - - default:user::rwx,default:group::rwx,default:other::r-x"

    # Set proper default ACLs for the movies directory
    "A+ /mnt/mac/Volumes/Storage/Data/media/movies - - - - default:user::rwx,default:group::rwx,default:other::r-x"
  ];
