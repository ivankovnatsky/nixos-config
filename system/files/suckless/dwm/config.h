...
static const Rule rules[] = {
	...
	{ NULL,				NULL,		"Cryptomator",	1 << 3,		0,		-1 },
	{ NULL,				NULL,		"Bitwarden",	1 << 3,		0,		-1 },
};
...
static const char *termcmd[]	= { "st", "-e", "tmuxinator", "start", "home", NULL };
...
static const char *micmutecmd[]		= { "pamixer", "--default-source", "-t", NULL };
...
static const char *autorandrallcmd[]		= { "autorandr", "all", NULL };
static const char *autorandrmonitorcmd[]	= { "autorandr", "monitor", NULL };
static const char *autorandrlaptopcmd[]		= { "autorandr", "laptop", NULL };
...
static Key keys[] = {
	...
	{ Mod1Mask|MODKEY|ControlMask|ShiftMask,XK_a,				spawn,		{.v = autorandrallcmd } },
	{ Mod1Mask|MODKEY|ControlMask|ShiftMask,XK_m,				spawn,		{.v = autorandrmonitorcmd } },
	{ Mod1Mask|MODKEY|ControlMask|ShiftMask,XK_l,				spawn,		{.v = autorandrlaptopcmd } },
};
