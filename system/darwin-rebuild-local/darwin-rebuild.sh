...
runActivateUser() {
  # Skip deprecated activate-user script to avoid sudo timestamp issues
  # The script only prints deprecation warnings and does nothing useful
  printf >&2 '%s: skipping deprecated activate-user script\n' "$0"
}
