        ...
        ExecStart =
          let
            ...
            rebuildWatchScript = pkgs.writeShellScriptBin "nixos-rebuild-watch" ''
              ...
              REBUILD_CMD="env PATH=/run/wrappers/bin:$PATH NIXPKGS_ALLOW_UNFREE=1 ${config.system.build.nixos-rebuild}/bin/nixos-rebuild switch --sudo --impure --verbose -L --flake ."
